...
const designs = [
  {
    id: 1,
    title: "Persius",
    img: "https://kouchinni.com/wp-content/uploads/2023/11/Persius.jpg",
  ...
  },
  {
    id: 2,
    title: "Royal ibex",
    img: "https://kouchinni.com/wp-content/uploads/2023/11/Royal-Ibex-300x453.jpg",
  ...
  },
  {
    id: 3,
    title: "Atousa",
    img: "https://kouchinni.com/wp-content/uploads/2023/11/Atusa-300x453.jpg",
  ...
  },
  {
    id: 4,
    title: "Homage",
    img: "https://kouchinni.com/wp-content/uploads/2023/12/design-homage-300x453.jpg",
    logoUrl:
  ...
  return (
    <section className="py-14 px-6 mt-20 md:px-12">
      <p className="text-thin text-[8px] text-center text-gray-500 uppercase pb-2">
        explore our new design catalogue
      </p>
        ...
        {designs.map((design) => (
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 z-20 transition-all duration-500 ease-in-out group-hover:bottom-16">
              <h4
                className={`${yantramanav.className} text-white text-left text-lg font-bold uppercase`}
              >
                {design.title}
              </h4>
            </div>
